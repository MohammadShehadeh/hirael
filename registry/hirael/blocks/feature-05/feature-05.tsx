  ...
  React.useEffect(() => {
    ...
    const draw = (now: number) => {
      ...
      for (const dot of dots) {
        const alpha =
          0.15 + 0.85 * (0.5 + 0.5 * Math.sin(dot.phase + t * dot.speed));
    ...
    <section data-slot="feature" className="bg-background py-20 sm:py-28">
      <div className="container w-full">
        ...
        >
          ...
          >
            Six decisions we make the same way every time, so you never have to
            guess how a new component will behave.
          </motion.p>
        </div>
