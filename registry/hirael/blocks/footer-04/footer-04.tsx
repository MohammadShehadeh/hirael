...
const BRAND = {
  name: "Hirael",
  blurb:
    "Components, blocks and full pages that shadcn/ui doesn't ship. Install the source, keep the source.",
...
const PLACEHOLDERS = [
  ...
  "One email per release, no noise",
];
...
export interface FooterSubscribeProps extends Omit<
        ...
        <div className="container py-12 md:py-16">
          <div className="grid grid-cols-2 gap-x-6 gap-y-10 lg:grid-cols-4">
            <Reveal
              ...
              className="col-span-2 flex flex-col gap-4 lg:col-span-1"
            >
              <a
                href="#"
                className={cn(
