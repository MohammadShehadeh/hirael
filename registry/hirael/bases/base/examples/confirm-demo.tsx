...
import { ConfirmProvider, useConfirm } from '@/registry/hirael/bases/base/components/confirm';

const ConfirmDemoInner = () => {
  const t = useT();
  const confirm = useConfirm();
  const [status, setStatus] = React.useState<React.ReactNode>(t({ en: 'No action yet.', ar: 'لا إجراء بعد.' }));
