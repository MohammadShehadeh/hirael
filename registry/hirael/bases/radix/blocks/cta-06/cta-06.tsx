          ...
          <div className="relative z-10 grid h-full content-center gap-6 px-4 py-6 md:grid-cols-[1fr_auto] md:items-center md:gap-10 md:px-8">
            <div className="flex flex-col items-start">
              ...
              <h2 className="mt-3 max-w-lg text-start font-serif text-3xl font-medium leading-[1.05] tracking-tight text-foreground sm:text-4xl md:text-5xl">
                Ship faster without <span className="italic">fighting your tools.</span>
              </h2>
              <p className="mt-3 max-w-xl text-start text-sm text-muted-foreground sm:text-base">
                Connect your account, get instant insights, and start building in minutes.
              </p>
            </div>
            ...
            >
              <Button asChild size="lg" className="w-full rounded-md px-6 sm:w-auto">
                <a href="#">
