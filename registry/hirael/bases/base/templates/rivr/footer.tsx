...
export const Footer = () => {
  return (
    <footer data-slot="footer" className="border-t border-border bg-background text-foreground">
      <div className="mx-auto w-full max-w-[1536px] px-6 py-16 md:px-10 md:py-20">
        <div className="flex flex-col gap-12 md:flex-row md:justify-between">
          <div className="max-w-xs">
            <a href="#home" className="flex w-fit items-center gap-2 text-foreground" aria-label="RIVR home">
          ...
          <nav aria-label="Footer" className="grid grid-cols-2 gap-8 sm:grid-cols-3 md:gap-16">
            {COLUMNS.map((column) => (
        ...
        <div className="mt-12 border-t border-border pt-8">
          <p className="text-sm text-muted-foreground">© 2026 RIVR. Fluid asset streams.</p>
        </div>
      </div>
    </footer>
  );
