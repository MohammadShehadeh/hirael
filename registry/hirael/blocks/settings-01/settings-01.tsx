...
const Settings = ({ className, ...props }: SettingsProps) => {
  return (
    <div
      data-slot="settings"
      className={cn(
        "grid w-full gap-6 md:grid-cols-[11rem_minmax(0,1fr)] md:gap-10",
        className,
      )}
      {...props}
    />
...
const SettingsRow = ({
  ...
  return (
    <Field
      ...
      className={cn(
        "gap-3 px-5 py-4 @md/field-group:justify-between @md/field-group:gap-8",
        className,
      )}
      {...props}
    >
      ...
      <div className="mx-auto w-full max-w-5xl px-4 py-8 sm:px-6 sm:py-10">
        <div className="mb-8 flex flex-col gap-1">
          ...
          <p className="text-sm text-muted-foreground">
            Your profile, contact email, and how the app behaves for you.
          </p>
        </div>
          ...
          <div className="flex min-w-0 flex-col gap-6">
            <SettingsSection id="profile">
              ...
              <FieldGroup className="gap-0 divide-y divide-border">
                <SettingsRow
                  label="Avatar"
                  description="PNG or JPG, at least 256 by 256."
                >
            ...
            <SettingsSection id="email">
              <SettingsSectionHeader>
                ...
                <SettingsSectionDescription>
                  Where sign-in links, receipts, and alerts go.
                </SettingsSectionDescription>
              </SettingsSectionHeader>
              <FieldGroup className="gap-0 divide-y divide-border">
                <SettingsRow
            ...
            <SettingsSection id="preferences">
              <SettingsSectionHeader>
                ...
                <SettingsSectionDescription>
                  Language, time zone, and calendar defaults.
                </SettingsSectionDescription>
              </SettingsSectionHeader>
              <FieldGroup className="gap-0 divide-y divide-border">
                <SettingsRow
            ...
            <SettingsSection id="danger" destructive>
              <SettingsSectionHeader>
                ...
                <SettingsSectionDescription>
                  These actions cannot be undone. Take a moment.
                </SettingsSectionDescription>
              </SettingsSectionHeader>
              <SettingsRow
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        ...
                        and every workspace you own. Teammates lose access
