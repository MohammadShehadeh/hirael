...
const QuickAction = ({ className, render, ...props }: QuickActionProps) => {
  return useRender({
    ...
    props: mergeProps<'button'>(
      ...
      {
        className: cn(
          'group flex flex-col items-start gap-2.5 rounded-lg border border-border bg-card p-3 text-start transition-colors duration-150 hover:bg-accent focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none data-popup-open:bg-accent',
          className,
        ),
      },
      props,
