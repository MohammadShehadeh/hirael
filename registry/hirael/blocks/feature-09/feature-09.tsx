...
const CELLS = [
  {
    ...
    title: "Build",
    description:
      "Compile, bundle and containerize with per-branch caches that survive between runs.",
  ...
  },
  {
    ...
    title: "Test",
    description:
      "Split suites across parallel runners and merge the reports back into one view.",
  },
  {
    icon: Rocket,
    title: "Deploy",
    description:
      "Gate releases on approvals, roll out per environment, roll back from the graph.",
  },
  {
    icon: Bell,
    title: "Notify",
    description:
      "Route failures to the people who can fix them, not a channel everyone mutes.",
  },
  {
    icon: CalendarClock,
    title: "Schedule",
    description:
      "Nightly builds, weekly cleanups and cron-style triggers without a separate service.",
  },
  {
    icon: MoreHorizontal,
    ...
    >
      ...
      >
        ...
        <p className="text-base leading-relaxed text-muted-foreground md:text-lg">
          Steps are typed, so the canvas knows what connects to what. Pick a
          stage, wire it in, and the pipeline stays legible.
        </p>
      </div>
