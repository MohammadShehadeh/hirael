...
const TESTIMONIALS: readonly Testimonial[] = [
  ...
  {
    quote:
      "RTL worked on the first render. That alone saved our Arabic launch a full sprint.",
    name: "Omar Nasser",
  ...
  {
    quote:
      "Every block uses our existing tokens. Light and dark both looked right without a single override.",
    name: "Jonas Keller",
    role: "Product designer, Kestrel",
  },
  {
    quote:
      "Data tables that handle keyboard navigation properly are rare. These do, out of the box.",
    name: "Mei Tanaka",
    role: "Accessibility lead, Fold",
  },
  {
    quote:
      "No runtime package means no upgrade surprises. We edit the files like they are ours, because they are.",
    name: "Samuel Osei",
    role: "CTO, Brightline",
  },
];
...
const GlowingRing = ({ className }: { className?: string }) => {
  ...
  return (
    <div
      ...
      aria-hidden
      className={cn(
        "relative size-12 shrink-0 overflow-hidden rounded-full bg-primary/5",
        className,
      )}
    >
          ...
          {TESTIMONIALS.map((item, i) => (
            ...
            >
              ...
              <figcaption
                ...
                className="mt-auto flex flex-col text-sm"
              >
