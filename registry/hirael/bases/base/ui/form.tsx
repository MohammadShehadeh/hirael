...
/**
 * Wires the field's `id`, `aria-describedby` and `aria-invalid` onto the
 * control. Pass the control via `render` (Base UI style) or as the only child
 * (Radix `Slot` style); both merge the props into that element.
 */
