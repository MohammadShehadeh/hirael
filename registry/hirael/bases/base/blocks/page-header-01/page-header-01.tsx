...
import {
  ...
  AvatarGroupCount,
  AvatarImage,
} from '@/registry/hirael/bases/base/ui/avatar';
...
import {
  ...
  BreadcrumbPage,
  BreadcrumbSeparator,
} from '@/registry/hirael/bases/base/ui/breadcrumb';
                ...
                <BreadcrumbItem className="md:hidden">
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="start">
                      <DropdownMenuItem render={<a href="#" />}>Projects</DropdownMenuItem>
                      <DropdownMenuItem render={<a href="#" />}>Web platform</DropdownMenuItem>
                    </DropdownMenuContent>
                  </DropdownMenu>
                </BreadcrumbItem>
              ...
              <DetailHeaderActions style={stagger(2, 80)} className={ENTER}>
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="w-44">
                    ...
                    <DropdownMenuItem onClick={() => setArchived(!archived)}>
