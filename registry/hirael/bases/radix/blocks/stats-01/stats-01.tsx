...
const StatsHeader = ({ className, ...props }: StatsHeaderProps) => {
  return <div data-slot="stats-header" className={cn('flex flex-col gap-5 lg:col-span-5', className)} {...props} />;
};
...
const StatsDescription = ({ className, ...props }: StatsDescriptionProps) => {
  return (
    <p
      ...
      className={cn('max-w-md text-sm text-muted-foreground sm:text-base', className)}
      {...props}
    />
  );
};
...
const StatsGrid = ({ className, ...props }: StatsGridProps) => {
  return (
    <div
      ...
      className={cn('grid grid-cols-2 border-y border-border md:grid-cols-4 lg:col-span-7', className)}
      {...props}
    />
  );
};
...
const StatsItem = ({ className, ...props }: StatsItemProps) => {
  return (
    <div
      ...
      className={cn(
        'flex flex-col gap-2 border-border px-4 py-6 sm:px-5 sm:py-8',
...
const StatsLabel = ({ className, ...props }: StatsLabelProps) => {
  return <div data-slot="stats-label" className={cn('text-sm text-muted-foreground', className)} {...props} />;
};
