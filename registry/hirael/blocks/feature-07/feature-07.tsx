      ...
      >
        ...
        <h2 className="font-serif text-3xl font-medium tracking-tight md:text-4xl lg:text-5xl">
          ...
          <span className="text-muted-foreground">
            is work you can&apos;t trust
          </span>
        </h2>
        <p className="mx-auto text-sm leading-relaxed text-muted-foreground md:text-base">
          Configuration as text scales badly once pipelines branch, fan out and
          gate deployments. The shape of the workflow disappears into the file.
        </p>
      </div>
        ...
        {CHALLENGES.map((challenge, i) => (
          ...
          >
            ...
            >
              ...
              <challenge.icon
                aria-hidden
                className="relative z-20 size-12 text-warm"
              />
            </div>
