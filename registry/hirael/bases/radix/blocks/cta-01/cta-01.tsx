        ...
        >
          ...
          <div className="relative grid grid-cols-1 gap-10 p-8 sm:p-12 lg:grid-cols-12 lg:items-center lg:gap-16 lg:p-14">
            ...
            <div className="flex flex-col gap-3 lg:col-span-5 lg:items-end">
              <Button asChild size="lg" className="group w-full justify-between rounded-full px-7 lg:w-auto">
                <a href="#">
              ...
              <Button asChild variant="outline" size="lg" className="w-full rounded-full px-7 lg:w-auto">
