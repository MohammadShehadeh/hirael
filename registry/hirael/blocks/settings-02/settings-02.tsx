...
const SettingsPanelDescription = ({
  ...
  return (
    <p
      data-slot="settings-panel-description"
...
interface SettingsPanelItemProps extends Omit<
...
const SettingsPanelSessions = ({
  className,
  ...props
}: SettingsPanelSessionsProps) => {
  return (
    <ul
      data-slot="settings-panel-sessions"
...
interface SettingsPanelSessionProps extends Omit<
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <span className="flex flex-wrap items-center gap-2">
          ...
          {current ? (
            <Badge
              variant="outline"
              className="gap-1.5 border-accent-cool/40 text-accent-cool"
            >
              <span
                aria-hidden
                className="size-1.5 rounded-full bg-accent-cool"
              />
              This device
            </Badge>
          ) : null}
  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        description:
          "New features and changelog highlights, about once a month.",
      },
    ],
  },
];
...
const Settings02 = () => {
  ...
  const canUpdatePassword =
    current.length > 0 && next.length >= 8 && confirm === next;
  ...
  const notificationsDirty =
    paused !== saved.paused ||
    (Object.keys(prefs) as NotificationKey[]).some(
      (k) => prefs[k] !== saved.prefs[k],
    );

  return (
    <section
      data-slot="settings-02-block"
            ...
            <SettingsPanel>
              <SettingsPanelHeader>
                <div className="flex flex-col gap-1">
                  ...
                  <SettingsPanelDescription>
                    Use at least 8 characters. A passphrase is easier to
              ...
              >
                <FieldGroup className="gap-5">
                  ...
                  <div className="grid gap-5 sm:grid-cols-2">
                    ...
                    <Field
                      className="gap-2"
                      data-invalid={confirmMismatch || undefined}
                    >
            ...
            <SettingsPanel>
              <SettingsPanelHeader>
                <div className="flex flex-col gap-1">
                  ...
                  <SettingsPanelDescription>
                    Devices signed in to your account. Revoke anything you do
                    not recognise.
                  </SettingsPanelDescription>
                </div>
            ...
            <SettingsPanel>
              <SettingsPanelHeader>
                <div className="flex flex-col gap-1">
                  ...
                  <SettingsPanelDescription>
                    Sent to mohammad@plinth.dev. Pausing keeps your choices for
                    when you come back.
                  </SettingsPanelDescription>
                </div>
                <Field
                ...
                >
                  <FieldLabel
                    htmlFor="settings-pause-all"
                    className="text-xs font-normal text-muted-foreground"
                  >
                    Pause all
                  </FieldLabel>
                  <Switch
                    id="settings-pause-all"
                    checked={paused}
