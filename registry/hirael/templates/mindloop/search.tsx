...
const PLATFORMS = [
  ...
  },
  {
    ...
    Icon: PerplexityIcon,
    description:
      "It cites its sources out loud. Be one of them, or watch a competitor get the citation instead.",
  },
  {
    name: "Google AI",
    Icon: GoogleAiIcon,
...
export function Search() {
  ...
  return (
    <section
      id="use-cases"
      className="px-8 pb-6 pt-52 md:px-28 md:pb-9 md:pt-64"
    >
      <div className="mx-auto max-w-5xl text-center">
        <motion.h2
          {...fade(0)}
          className="text-5xl tracking-[-2px] md:text-7xl lg:text-8xl"
        >
        ...
        <motion.p
          {...fade(0.1)}
          className="mx-auto mt-8 mb-24 max-w-2xl text-lg text-muted-foreground"
        >
          People used to type keywords and scroll. Now they ask a question and
          read one answer. Make sure it sounds like you.
        </motion.p>
