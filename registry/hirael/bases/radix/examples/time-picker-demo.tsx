...
import {
  ...
  TimePickerTrigger,
  type TimeValue,
} from '@/registry/hirael/bases/radix/components/time-picker';
  ...
  return (
    <FieldGroup className="grid max-w-md grid-cols-1 gap-8 sm:grid-cols-2">
      <Field className="gap-2">
        <FieldLabel htmlFor="tp-meeting">{t({ en: 'Meeting time (24h)', ar: 'وقت الاجتماع (24 ساعة)' })}</FieldLabel>
        <TimePicker value={t24} onValueChange={setT24} format="24h" minuteStep={5}>
