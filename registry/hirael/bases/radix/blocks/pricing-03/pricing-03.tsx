...
const PLANS: readonly Plan[] = [
  {
    ...
    features: ['1,000 generations / month', 'Base model access', 'Community support', '500MB model storage'],
    cta: 'Start free',
    ctaVariant: 'outline',
  },
  {
    ...
    features: ['Unlimited generations', 'Premium model access', 'Priority support', '10GB model storage'],
    cta: 'Choose Pro',
    ctaVariant: 'default',
    popular: true,
  },
    ...
    <section className="relative overflow-hidden bg-background py-20 text-foreground sm:py-28">
      ...
      <div className="container relative flex flex-col items-center gap-8">
        <div className="flex max-w-2xl flex-col items-center gap-4 text-center">
          ...
          <motion.p {...reveal(0.1)} className="text-base text-muted-foreground sm:text-lg">
            Flexible plans that scale from a weekend build to production. Switch or cancel anytime.
          </motion.p>
        </div>
              ...
              <motion.div key={plan.id} {...reveal(0.2 + index * 0.08)}>
                ...
                >
                      ...
                      {typeof amount === 'number' ? (
                        <div className="flex items-baseline gap-1">
                          <AnimatedNumber
                            ...
                            value={amount}
                          />
                          <span className="font-mono text-xs text-muted-foreground">/mo, billed {frequency}</span>
                        </div>
                      ) : (
                  ...
                  <CardFooter className="mt-auto px-0 pt-2">
                    <Button asChild variant={plan.ctaVariant} size="lg" className="group w-full rounded-full">
                      <a href="#">
                        {plan.cta}
