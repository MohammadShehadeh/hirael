  ...
  return (
    <section className="relative overflow-hidden bg-background px-6 pb-10 pt-32 md:pb-14 md:pt-44">
      ...
      <div className="relative mx-auto max-w-5xl text-center">
        ...
        >
          Pioneering <Serif className="text-foreground/60">ideas</Serif> for <br className="hidden md:block" />
          minds that <Serif className="text-foreground/60">create, build, and inspire.</Serif>
        </motion.h2>
      </div>
    </section>
  );
