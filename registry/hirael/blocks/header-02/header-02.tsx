...
const HeaderBar = ({ className, ...props }: HTMLMotionProps<"div">) => {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "relative mx-auto hidden min-w-[720px] max-w-6xl items-center justify-between rounded-full border px-3 py-2 backdrop-blur-md transition-[background-color,border-color,box-shadow] duration-300 lg:flex",
        isShrunk
  ...
  return (
    <AnimatePresence initial={false}>
      {open ? (
        ...
        >
          <div
            className={cn("flex flex-col gap-1 px-1 pt-3 pb-2", className)}
            {...props}
          >
            {children}
          </div>
    ...
    >
      ...
      <div className="container flex flex-col gap-6 py-20 md:py-28">
        ...
        <p className="max-w-xl text-base text-muted-foreground sm:text-lg">
          Full width at the top of the page, a floating pill after the first
          hundred pixels. The links keep a sliding hover state either way.
        </p>
