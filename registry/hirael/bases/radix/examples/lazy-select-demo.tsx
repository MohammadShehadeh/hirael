...
import {
  ...
  type LazyPage,
} from '@/registry/hirael/bases/radix/components/lazy-select';
...
const FIRST_NAMES = {
  en: ['Ava', 'Liam', 'Noah', 'Mia', 'Zoe', 'Ezra', 'Iris', 'Omar', 'Lena', 'Kai'],
  ar: ['سارة', 'خالد', 'ليلى', 'عمر', 'نور', 'يوسف', 'فاطمة', 'أحمد', 'هدى', 'زيد'],
};
const LAST_NAMES = {
  ...
  return (
    <Field className="max-w-md gap-2">
      ...
      <LazySelect
        ...
        onLoadMore={loadMore}
      >
        <LazySelectTrigger id="lazy-assignee" placeholder={t({ en: 'Select a teammate…', ar: 'اختر زميلًا…' })} />
        <LazySelectContent
          searchPlaceholder={t({
            en: 'Search teammates…',
            ar: 'ابحث عن زملاء…',
