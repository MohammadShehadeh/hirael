...
const CARD_IMAGE = '/media/templates/usd-halo/info-card.webp';
      ...
      <div className="mx-auto max-w-[88rem]">
        <div className="mb-16 grid grid-cols-1 items-start gap-12 md:grid-cols-2">
          ...
          <p className="text-2xl leading-relaxed text-black/70 md:text-3xl">
            USD Halo is a reward-earning dollar coin that lets your savings grow while remaining tied to the U.S.
            dollar.
          </p>
        </div>
