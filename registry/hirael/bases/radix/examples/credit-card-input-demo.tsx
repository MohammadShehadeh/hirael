...
} from '@/registry/hirael/bases/radix/components/credit-card-input';
      ...
      <div className="grid gap-2">
        ...
        >
          <FieldGroup className="gap-3">
            <Field className="gap-2" data-invalid={errors.length > 0 || undefined}>
              <FieldLabel htmlFor="checkout-card-number">{t({ en: 'Card details', ar: 'بيانات البطاقة' })}</FieldLabel>
