      ...
      <TableCell className="text-end">
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-48">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem variant="destructive" disabled={roleLocked} onClick={() => setConfirmOpen(true)}>
              Remove from team
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
  ...
  return (
    ...
    >
      ...
      <span className="flex items-center gap-1">
        ...
        <AlertDialog>
          <AlertDialogTrigger render={<Button type="button" variant="ghost" size="sm" />}>Revoke</AlertDialogTrigger>
