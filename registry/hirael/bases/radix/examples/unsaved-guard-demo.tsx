...
import { UnsavedGuardProvider, useUnsavedGuard } from '@/registry/hirael/bases/radix/components/unsaved-guard';
      ...
      {tab === 'profile' ? (
        ...
        >
          <Field className="gap-1.5">
            <FieldLabel htmlFor={nameId}>{t({ en: 'Display name', ar: 'الاسم الظاهر' })}</FieldLabel>
