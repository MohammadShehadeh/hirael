...
const CONVERSATIONS: readonly Conversation[] = [
  ...
  {
    id: 'invoice-april',
    sender: 'Hirael Billing',
    initials: 'HB',
    email: 'billing@hirael.com',
    ...
    <div data-slot="app-shell" className="flex min-h-[640px] bg-background">
      ...
      >
        <span
          role="img"
          aria-label="Hirael"
          className="mb-2 flex size-8 items-center justify-center rounded-sm text-foreground"
        >
