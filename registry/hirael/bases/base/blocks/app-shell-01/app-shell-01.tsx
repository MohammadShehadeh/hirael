...
import {
  ...
  SidebarSeparator,
  SidebarTrigger,
} from '@/registry/hirael/bases/base/ui/sidebar';
...
const AppShell01 = () => {
  ...
  const visibleRows = React.useMemo(() => {
    ...
    const matches = q
      ? ROWS.filter(
          (r) =>
            r.name.toLowerCase().includes(q) || r.plan.toLowerCase().includes(q) || r.status.toLowerCase().includes(q),
        )
      : ROWS;
      ...
      <Sidebar collapsible="icon">
        ...
        <SidebarFooter>
          <SidebarMenu>
            <SidebarMenuItem>
              <DropdownMenu>
                <DropdownMenuTrigger render={<SidebarMenuButton size="lg" tooltip="Mohammad Shehadeh" />}>
        ...
        <div data-slot="app-shell-main" className={cn(ENTER, 'flex flex-1 flex-col gap-5 p-4 sm:p-6')}>
          <div className="flex flex-col gap-1">
            ...
            <p className="text-sm text-muted-foreground">
              An overview of customers, revenue, and recent activity. Changes compare against the previous 30 days.
            </p>
          </div>
                        ...
                        <TableCell className="text-end">
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end" className="w-44">
                              ...
                              <DropdownMenuSeparator />
                              <DropdownMenuItem variant="destructive">Remove account</DropdownMenuItem>
                            </DropdownMenuContent>
                          </DropdownMenu>
                        </TableCell>
                      </TableRow>
