  ...
  return (
    ...
    >
      <div className="flex w-full max-w-[1200px] flex-col items-center gap-5 text-center">
        <h2 className="font-medium text-white" style={{ fontSize: 'clamp(32px, 4vw, 56px)', lineHeight: 1.2 }}>
          Relied on by enterprise teams
          <br />
          <GradientText>from groundbreak to go-live.</GradientText>
        </h2>
        <p className="text-[var(--nexa-lavender-2)]" style={{ fontSize: 'clamp(14px, 1.25vw, 18px)' }}>
