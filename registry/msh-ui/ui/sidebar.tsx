...
import { Skeleton } from "@/registry/msh-ui/ui/skeleton"
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
  TooltipTrigger,
} from "@/registry/msh-ui/ui/tooltip"
      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            ...
            <SheetDescription>Displays the showcase sidebar.</SheetDescription>
          </SheetHeader>
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-muted-foreground font-mono ring-sidebar-ring flex h-8 shrink-0 items-center rounded-sm px-2 text-[10px] font-medium uppercase tracking-[0.12em] outline-none transition-[margin,opa] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
