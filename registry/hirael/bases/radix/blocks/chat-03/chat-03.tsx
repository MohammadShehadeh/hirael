...
import {
  ...
  useMentionInput,
  type MentionItem,
} from '@/registry/hirael/bases/radix/components/mention-input';
...
const ChannelMessageToolbar = ({ className, ...props }: ChannelMessageToolbarProps) => {
  return (
    <div
      ...
      className={cn(
        'pointer-events-none absolute end-3 -top-3 z-10 flex items-center gap-0.5 rounded-md border border-border bg-popover p-0.5 text-popover-foreground opacity-0 shadow-sm transition-opacity duration-150 group-focus-within/message:pointer-events-auto group-focus-within/message:opacity-100 group-hover/message:pointer-events-auto group-hover/message:opacity-100 group-data-[active]/message:pointer-events-auto group-data-[active]/message:opacity-100 has-[[data-state=open]]:pointer-events-auto has-[[data-state=open]]:opacity-100 motion-reduce:transition-none',
        className,
      )}
      {...props}
    />
