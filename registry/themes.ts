...
export interface ThemeItem {
  name: string;
  title: string;
  cssVars: { light: ThemeTokens; dark: ThemeTokens };
}

export const HIRAEL_THEME: ThemeItem = {
  name: 'hirael',
  title: 'Hirael',
  cssVars: { light: {}, dark: {} },
};
...
export const THEME_BY_NAME: Record<string, ThemeItem> = Object.fromEntries(THEMES.map((theme) => [theme.name, theme]));
