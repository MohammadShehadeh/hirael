...
> = {
  "multi-select": () =>
    import("@/registry/hirael/multi-select/multi-select.demo"),
  "number-range": () =>
    import("@/registry/hirael/number-range/number-range.demo"),
  ...
  "password-input": () =>
    import("@/registry/hirael/password-input/password-input.demo"),
  "currency-input": () =>
    import("@/registry/hirael/currency-input/currency-input.demo"),
  "phone-input": () => import("@/registry/hirael/phone-input/phone-input.demo"),
  "file-dropzone": () =>
    import("@/registry/hirael/file-dropzone/file-dropzone.demo"),
  ...
  "scroll-progress": () =>
    import("@/registry/hirael/scroll-progress/scroll-progress.demo"),
  ...
  "month-picker": () =>
    import("@/registry/hirael/month-picker/month-picker.demo"),
  "time-picker": () => import("@/registry/hirael/time-picker/time-picker.demo"),
  "color-picker": () =>
    import("@/registry/hirael/color-picker/color-picker.demo"),
  "avatar-stack": () =>
  ...
  "animated-number": () =>
    import("@/registry/hirael/animated-number/animated-number.demo"),
  ...
  "date-range-picker": () =>
    import("@/registry/hirael/date-range-picker/date-range-picker.demo"),
  "mention-input": () =>
    import("@/registry/hirael/mention-input/mention-input.demo"),
  "inline-edit": () => import("@/registry/hirael/inline-edit/inline-edit.demo"),
  "signature-pad": () =>
    import("@/registry/hirael/signature-pad/signature-pad.demo"),
  "image-cropper": () =>
    import("@/registry/hirael/image-cropper/image-cropper.demo"),
  "image-compare": () =>
    import("@/registry/hirael/image-compare/image-compare.demo"),
  lightbox: () => import("@/registry/hirael/lightbox/lightbox.demo"),
  "countdown-timer": () =>
    import("@/registry/hirael/countdown-timer/countdown-timer.demo"),
  "qr-code": () => import("@/registry/hirael/qr-code/qr-code.demo"),
  "calendar-heatmap": () =>
    import("@/registry/hirael/calendar-heatmap/calendar-heatmap.demo"),
  "code-block": () => import("@/registry/hirael/code-block/code-block.demo"),
  masonry: () => import("@/registry/hirael/masonry/masonry.demo"),
  "audio-player": () =>
    import("@/registry/hirael/audio-player/audio-player.demo"),
  "media-input": () => import("@/registry/hirael/media-input/media-input.demo"),
  tour: () => import("@/registry/hirael/tour/tour.demo"),
  "activity-feed": () =>
    import("@/registry/hirael/activity-feed/activity-feed.demo"),
  ...
  "scroll-reveal": () =>
    import("@/registry/hirael/scroll-reveal/scroll-reveal.demo"),
  "spotlight-card": () =>
    import("@/registry/hirael/spotlight-card/spotlight-card.demo"),
  "magnetic-button": () =>
    import("@/registry/hirael/magnetic-button/magnetic-button.demo"),
  "cursor-glow": () => import("@/registry/hirael/cursor-glow/cursor-glow.demo"),
  "tilt-card": () => import("@/registry/hirael/tilt-card/tilt-card.demo"),
  "morphing-dialog": () =>
    import("@/registry/hirael/morphing-dialog/morphing-dialog.demo"),
  dock: () => import("@/registry/hirael/dock/dock.demo"),
  "floating-action-button": () =>
    import("@/registry/hirael/floating-action-button/floating-action-button.demo"),
  "floating-toolbar": () =>
    import("@/registry/hirael/floating-toolbar/floating-toolbar.demo"),
  ...
  "language-switcher": () =>
    import("@/registry/hirael/language-switcher/language-switcher.demo"),
  "kpi-grid": () => import("@/registry/hirael/kpi-grid/kpi-grid.demo"),
  "quick-actions": () =>
    import("@/registry/hirael/quick-actions/quick-actions.demo"),
  notifications: () =>
    import("@/registry/hirael/notifications/notifications.demo"),
  "billing-card": () =>
    import("@/registry/hirael/billing-card/billing-card.demo"),
  "subscription-plans": () =>
    import("@/registry/hirael/subscription-plans/subscription-plans.demo"),
  "api-keys": () => import("@/registry/hirael/api-keys/api-keys.demo"),
  "usage-dashboard": () =>
    import("@/registry/hirael/usage-dashboard/usage-dashboard.demo"),
  "creative-studio": () =>
