...
const FaqCard = ({ index = 0, className, ...props }: FaqCardProps) => {
  return (
    <div
      className={`animate-in rounded-lg border border-border bg-card px-4 transition-colors duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] fill-mode-both fade-in slide-in-from-bottom-4 not-first:mt-3 has-data-open:bg-muted/40 motion-reduce:animate-none md:px-6`}
