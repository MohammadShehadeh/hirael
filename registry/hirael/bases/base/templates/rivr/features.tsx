...
const ICON_CHIP = 'flex size-12 items-center justify-center rounded-2xl bg-secondary text-foreground';

export const Features = () => {
  return (
    <section data-slot="features" className="mx-auto w-full max-w-[1536px] px-3 py-6 md:px-5 md:py-12">
      <motion.div
        {...fadeUp()}
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-3 md:grid-rows-2 md:gap-5">
        ...
        >
          ...
          <div className="relative">
            ...
            <p className="mt-3 max-w-sm text-sm leading-relaxed text-muted-foreground">
              Borrow against staked positions and NFTs without unwinding them. Your collateral keeps earning while the
              cash is in your hands.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="relative">
            <h3 className="text-xl font-semibold text-foreground md:text-2xl">Real-time Yields</h3>
            <p className="mt-3 max-w-md text-sm leading-relaxed text-muted-foreground">
              Rewards accrue every block and stay claimable. Watch positions compound live, with no lockups or waiting
              periods.
            </p>
          </div>
        </motion.div>

        <motion.div {...fadeUp(0.15)} className={`${CARD_BASE} flex flex-col justify-between`}>
          ...
          <div className="mt-6">
            ...
            <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
              Smart contracts audited by leading firms, with on-chain proofs you can verify yourself.
            </p>
            <a
              href="#"
        ...
        >
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">Move liquidity across networks.</p>
          </div>
        </motion.a>
      </div>
    </section>
