...
import { Card, CardContent, CardFooter, CardHeader } from '@/registry/hirael/bases/radix/ui/card';
...
const TIERS: readonly Tier[] = [
  {
    ...
    features: ['Full registry access', 'Up to 3 themes', 'Community support', 'Full source access'],
    cta: 'Start free',
    ctaVariant: 'outline',
  },
  {
    ...
    features: ['Everything in Hobby', 'Unlimited themes', 'Private registry mirror', 'Priority response'],
    cta: 'Start Pro trial',
    featured: true,
    ctaVariant: 'default',
  },
  {
    ...
    features: ['Everything in Pro', 'Shared workspace', 'SSO & audit log', 'SLA support'],
    cta: 'Contact sales',
    ctaVariant: 'outline',
  },
];
      ...
      <div className="container w-full">
        <div className="mx-auto flex max-w-2xl flex-col items-center gap-5 text-center">
          ...
          <h2 className="font-serif text-4xl font-medium leading-[1.04] tracking-tight sm:text-5xl">
            Pay for the parts you <span className="italic text-foreground">actually</span> use.
          </h2>
          <p className="text-base text-muted-foreground sm:text-lg">
            Source code stays free. Pay only when you need private mirrors, shared themes, or team-level controls.
          </p>
        </div>
