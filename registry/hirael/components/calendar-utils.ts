...
export const sameDay = (a: Date | null | undefined,
  b: Date | null | undefined,): boolean => {
  if (!a || !b) return false;
  return (
 ...
 */
export const gridKeyToDate = (key: string,
  d: Date,
  opts: { weekStartsOn: 0 | 1; shiftKey: boolean; forward: 1 | -1 },): Date | null => {
