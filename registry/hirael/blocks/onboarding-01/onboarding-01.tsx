...
import { RadioGroup, RadioGroupItem } from "@/registry/hirael/ui/radio-group";
import {
  Select,
  SelectContent,
  SelectItem,
...
interface OnboardingProps extends Omit<
      ...
      <Stepper value={step + 1} onValueChange={(s) => goTo(s - 1)}>
        {steps.map((meta, i) => (
          <StepperItem key={meta.title} step={i + 1} disabled={i > step}>
            <StepperTrigger
              aria-label={`Step ${i + 1}: ${meta.title}`}
              className="gap-2"
            >
...
const OnboardingStepDescription = ({
  className,
  ...props
}: OnboardingStepDescriptionProps) => {
  return (
    <p
...
const OnboardingFooter = ({
  ...
  return (
    <div
      ...
      className={cn(
        "flex items-center justify-between gap-2 border-t border-border pt-5",
        className,
      )}
      {...props}
    >
          ...
          >
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <p className="max-w-sm text-sm text-muted-foreground">
                {invitedCount > 0
                  ? `We sent ${invitedCount} ${invitedCount === 1 ? "invite" : "invites"}. `
                  : ""}
          ...
          >
              ...
              <OnboardingBody>
                <FieldGroup className="gap-5">
                  <Field className="gap-2">
                    <FieldLabel htmlFor="onboarding-workspace">
                      Workspace name
                    </FieldLabel>
                    <Input
                  ...
                  <Field className="gap-2">
                    <FieldLabel htmlFor="onboarding-slug">
                      Workspace URL
                    </FieldLabel>
                    <InputGroup>
            ...
            <OnboardingStep index={3}>
              ...
              <OnboardingBody>
                ...
                >
                  <FieldContent className="gap-0.5">
                    <FieldLabel htmlFor="onboarding-notify">
                      Email me a weekly digest
                    </FieldLabel>
                    <FieldDescription className="text-xs">
                      What changed, who joined, and what needs a look. Sent
                      Monday mornings.
                    </FieldDescription>
                  </FieldContent>
                  <Switch
