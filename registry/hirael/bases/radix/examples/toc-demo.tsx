...
import {
  ...
  TableOfContentsList,
  type TocItem,
} from '@/registry/hirael/bases/radix/components/toc';
...
const TocDemo = () => {
  ...
  return (
    <div className="grid w-full max-w-2xl gap-10 sm:grid-cols-2">
      <TableOfContents items={flatItems} label={onThisPage} aria-label={onThisPage} />

      <TableOfContents>
        <TableOfContentsLabel>{t({ en: 'Contents', ar: 'المحتويات' })}</TableOfContentsLabel>
