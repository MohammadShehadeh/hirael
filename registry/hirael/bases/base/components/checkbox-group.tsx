...
const TriStateCheckbox = ({ id, scope, invalid, describedBy, controls }: TriStateCheckboxProps) => {
  return (
    <span className="relative flex shrink-0">
      <Checkbox
        id={id}
        checked={scope.state === true}
        indeterminate={scope.state === 'indeterminate'}
        ...
        className="data-indeterminate:border-primary data-indeterminate:bg-primary data-indeterminate:text-primary-foreground dark:data-indeterminate:bg-primary data-indeterminate:[&_svg]:invisible"
      />
