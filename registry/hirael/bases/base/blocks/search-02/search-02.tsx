...
const ENTRIES: readonly Entry[] = [
  ...
  { id: 'deployments', kind: 'page', label: 'Deployments', detail: 'Projects / Northwind API', keywords: 'releases' },
  {
    id: 'amara-okafor',
    kind: 'person',
    label: 'Amara Okafor',
    detail: 'Engineering manager',
    keywords: 'amara@northwind.dev',
  },
  {
    id: 'daniel-reyes',
    kind: 'person',
    ...
    keywords: 'daniel@northwind.dev billing',
  },
  { id: 'hana-sato', kind: 'person', label: 'Hana Sato', detail: 'Product designer', keywords: 'hana@northwind.dev' },
  { id: 'jonas-weber', kind: 'person', label: 'Jonas Weber', detail: 'Support lead', keywords: 'jonas@northwind.dev' },
  {
    id: 'leila-haddad',
    kind: 'person',
    label: 'Leila Haddad',
    detail: 'Head of finance',
    keywords: 'leila@northwind.dev invoices',
  },
  {
    id: 'marcus-bell',
    kind: 'person',
    ...
    keywords: 'marcus@northwind.dev sales',
  },
  { id: 'priya-nair', kind: 'person', label: 'Priya Nair', detail: 'Data analyst', keywords: 'priya@northwind.dev' },
  {
    id: 'sofia-marin',
    kind: 'person',
    label: 'Sofia Marin',
    detail: 'Security engineer',
    keywords: 'sofia@northwind.dev sso audit',
  },
  {
    id: 'tom-becker',
    kind: 'person',
    ...
    keywords: 'tom@northwind.dev api webhooks',
  },
  {
    id: 'yusuf-demir',
    kind: 'person',
    ...
    keywords: 'yusuf@northwind.dev deployments',
  },
];
