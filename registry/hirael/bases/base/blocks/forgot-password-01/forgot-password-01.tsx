            ...
            <div role="status" aria-live="polite" className="flex flex-col items-center gap-4 px-8 py-10 text-center">
              ...
              <div className="flex flex-col gap-1">
                ...
                <p className="text-xs text-muted-foreground">
                  We sent a reset link to <span className="font-mono text-foreground">{email}</span>. It expires in 15
                  minutes.
                </p>
              </div>
              <div className="mt-2 flex flex-col items-center gap-2">
                <p className="text-xs text-muted-foreground">
                  Didn&apos;t get it?{' '}
                  <Button type="button" variant="link" size="xs" onClick={send} className="h-auto p-0">
                    Resend
                  </Button>
                </p>
                <a
