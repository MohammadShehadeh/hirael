...
const ErrorPageDetails = ({
  ...
  return (
    ...
    >
      ...
      >
        <ChevronDown className="size-3.5 transition-transform duration-150 group-data-open:rotate-180 motion-reduce:transition-none" />
        Technical details
      </CollapsibleTrigger>
      <CollapsibleContent className="motion-reduce:animate-none data-open:animate-in data-open:duration-250 data-open:ease-[cubic-bezier(0.22,1,0.36,1)] data-open:fade-in data-open:slide-in-from-top-1">
