...
const FaqCard = ({ index = 0, className, ...props }: FaqCardProps) => {
  return (
    <div
      className={`not-first:mt-3 rounded-lg border border-border bg-card px-4 transition-colors md:px-6 has-data-open:bg-muted/40 animate-in fade-in slide-in-from-bottom-4 duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] fill-mode-both motion-reduce:animate-none`}
  ...
  return (
    <section data-slot="faq" className="bg-background py-16 md:py-24">
      <div className="mx-auto w-full max-w-3xl px-6">
        ...
        <Accordion multiple data-slot="faq-list" className="flex flex-col">
          {FAQS.map((item, i) => (
