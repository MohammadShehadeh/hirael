...
import {
  ...
  AvatarStackItem,
  AvatarStackOverflow,
} from '@/registry/hirael/bases/base/components/avatar-stack';
  ...
  return (
    <div className="grid w-full max-w-3xl gap-8">
      ...
      <div className="grid gap-2">
        ...
        <AvatarStack>
          <AvatarStackItem render={<a href="#" aria-label={t({ en: 'Maya Renner', ar: 'سارة رينر' })} />}>
            {t({ en: 'MR', ar: 'سر' })}
          </AvatarStackItem>
          <AvatarStackItem render={<a href="#" aria-label={t({ en: 'Soren Kim', ar: 'خالد كيم' })} />}>
            {t({ en: 'SK', ar: 'خك' })}
          </AvatarStackItem>
          <AvatarStackItem render={<a href="#" aria-label={t({ en: 'Jules Tanaka', ar: 'ليلى تاناكا' })} />}>
            {t({ en: 'JT', ar: 'لت' })}
          </AvatarStackItem>
          <AvatarStackOverflow
            count={6}
