              ...
              <FieldGroup className="gap-0 divide-y divide-border">
                ...
                >
                  <Select
                    ...
                    onValueChange={(language) => setPrefs((p) => ({ ...p, language: language ?? '' }))}
                  >
                ...
                >
                  <Select
                    ...
                    onValueChange={(timezone) => setPrefs((p) => ({ ...p, timezone: timezone ?? '' }))}
                  >
                ...
                <SettingsRow label="Week starts on" htmlFor="settings-week">
                  <Select
                    ...
                    onValueChange={(weekStart) => setPrefs((p) => ({ ...p, weekStart: weekStart ?? '' }))}
                  >
