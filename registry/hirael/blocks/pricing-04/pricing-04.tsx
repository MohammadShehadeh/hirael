...
const Pricing04 = () => {
  return (
    <section
      data-slot="pricing"
      className="flex w-full flex-col gap-16 bg-background px-6 py-16 md:px-10 md:py-24"
    >
      <div
      ...
      >
        ...
        <p className="text-base leading-relaxed text-muted-foreground md:text-lg">
          Every plan includes the full editor. You pay for compute and
          retention, and collaborators are free everywhere.
        </p>
      </div>
