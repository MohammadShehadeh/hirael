...
import {
  ...
  InputOTPGroup,
  InputOTPSlot,
} from "@/registry/hirael/ui/input-otp";
...
const TwoFactorSetupContext =
  React.createContext<TwoFactorSetupContextValue | null>(null);
          ...
          >
            <span
              className={cn(
                ...
                state === "active" ? "w-6 bg-foreground" : "w-1.5",
...
const TwoFactorSetupDescription = ({
  className,
  ...props
}: React.ComponentProps<"p">) => {
  return (
    <p
      data-slot="two-factor-setup-description"
...
const TwoFactorSetupQr = ({
  value,
  size = 168,
  className,
  ...props
}: TwoFactorSetupQrProps) => {
  return (
    <div
      data-slot="two-factor-setup-qr"
      className={cn(
        "mx-auto inline-flex rounded-sm border border-border bg-background p-3",
        className,
      )}
      {...props}
    >
...
const TwoFactorSetupSecret = ({
  ...
  return (
    <div
      data-slot="two-factor-setup-secret"
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 rounded-sm border border-border bg-background ps-3 pe-1">
        <code
          dir="ltr"
          className="select-all font-mono text-sm tracking-[0.08em] text-foreground"
        >
          {grouped}
        </code>
        <CopyButton
...
export interface TwoFactorSetupCodeProps extends Omit<
...
const TwoFactorSetupRecoveryCodes = ({
  ...
  return (
    <div
      data-slot="two-factor-setup-recovery-codes"
      className={cn("flex flex-col gap-4", className)}
      {...props}
    >
      <ul
        dir="ltr"
        className="grid grid-cols-2 gap-px overflow-hidden rounded-sm border border-border bg-border"
      >
        {codes.map((code) => (
          <li
            key={code}
...
const TwoFactorSetupFooter = ({
  ...
  return (
    <div
      ...
      className={cn(
        "flex items-center justify-between gap-3 border-t border-border px-8 py-4",
        className,
      )}
      {...props}
    />
                  ...
                  {step === 0 ? (
                    ...
                    <>
                      ...
                      <TwoFactorSetupDescription>
                        ...
                        to confirm it&apos;s set up correctly.
                      </TwoFactorSetupDescription>
                    </>
                  ) : (
                    <>
                      ...
                      <TwoFactorSetupDescription>
                        Each code works once. Use them if you lose access to
