      ...
      <main id="main-content" tabIndex={-1} className="flex-1 outline-none">
        <section className="relative overflow-hidden">
          ...
          <div className="relative container flex w-full flex-col items-center gap-6 py-24 text-center sm:py-28 lg:py-36">
            <span className="inline-flex items-center rounded-full border border-border bg-card/60 px-3.5 py-1 font-mono text-[11px] uppercase tracking-[0.18em] text-muted-foreground backdrop-blur-sm">
              Error 404
            </span>
