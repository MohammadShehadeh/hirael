...
export default function OpenGraphImage() {
  ...
  return new ImageResponse(
    ...
    >
      <svg width="150" height="150" viewBox="80 104 352 352" fill="none" style={{ marginBottom: 36 }}>
        <path
        ...
        <path
          ...
          fill="#E7E4DE"
        />
        <path d="M95 372C160 364 352 364 417 372C352 380 160 380 95 372Z" fill="#E7E4DE" />
        <path d="M135 405C185 399 327 399 377 405C327 411 185 411 135 405Z" fill="#E7E4DE" />
        <path d="M190 438C220 434 292 434 322 438C292 442 220 442 190 438Z" fill="#E7E4DE" />
      </svg>
      <div
        style={{
          display: 'flex',
