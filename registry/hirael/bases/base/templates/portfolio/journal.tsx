...
const ENTRIES = [
  {
    ...
    image: '/media/templates/portfolio/journal-motion-and-meaning.jpg',
    readTime: '6 min read',
    date: 'May 2026',
  },
  {
    title: 'The quiet power of constraints',
    image: '/media/templates/portfolio/journal-quiet-constraints.jpg',
    readTime: '4 min read',
    date: 'Apr 2026',
  },
  {
    title: 'Systems that scale with the team',
    image: '/media/templates/portfolio/journal-systems-that-scale.jpg',
    readTime: '8 min read',
    date: 'Mar 2026',
  },
  {
    title: 'Notes on color and contrast',
    image: '/media/templates/portfolio/journal-color-and-contrast.jpg',
    readTime: '5 min read',
    date: 'Feb 2026',
  },
];
